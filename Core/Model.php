...
abstract class Model
{
	...
	public function errorMessages()
	{
		return [
			...
			self::RULE_MIN => "Mininum length of this field must be minimum {min}",
			self::RULE_MAX => "Maximum length of this field must be maximum {max}",
